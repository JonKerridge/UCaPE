...
int nodeId = Ask.Int ("Node identification (2..9) ? ", 2, 9)
def Boolean last = Ask.Boolean ("Is this the last node? - ( y or n):")
 int sentMessages = Ask.Int("Number of messages to be sent by a Sender (100 - 2000)? ", 100, 2000)
int nodes = Ask.Int("Number of nodes (excluding the Extra Node) ? ", 1, 8)
